--[[
This file has code from the Geyser UI Template on the Mudlet forums.
I just combined that all into one file, and my own new logic is in separate part.
I will leave this part pretty much unchanged unless I have to.

It came from https://forums.mudlet.org/viewtopic.php?t=4098
